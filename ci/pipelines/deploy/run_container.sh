...
$DOCKER_EXEC exec -w /sw6 "${CONTAINER_NAME}" composer install
$DOCKER_EXEC exec -w /sw6 "${CONTAINER_NAME}" yarn install
$DOCKER_EXEC exec -w /sw6 "${CONTAINER_NAME}" yarn encore dev
